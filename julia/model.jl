...
function nameless_start_(cons)
    ...
    dose_amount = F_PFM * 1000000.0 * cons[80] * F_PFM
    PFM_gut = 0.0
    ...
    vA_syn_b = BRAIN * cons[95] * cons[20] * NAPE_b / cons[25] / den_b
    vO_syn_b = BRAIN * cons[95] * cons[21] * NOPE_b / cons[26] / den_b
    vP_syn_b = BRAIN * cons[95] * cons[22] * NPPE_b / cons[27] / den_b
    vL_syn_b = BRAIN * cons[95] * cons[23] * NLPE_b / cons[28] / den_b
    vS_syn_b = BRAIN * cons[95] * cons[24] * NSPE_b / cons[29] / den_b
    ...
    c_NAT_ROB = cons[104] * cons[13] + cons[100] * cons[14] + cons[105] * cons[15] + cons[101] * cons[16] + cons[106] * cons[17] + cons[102] * cons[18] + cons[103] * cons[19]
    ...
    vA_syn_r = ROB * cons[96] * cons[20] * NAPE_r / cons[25] / den_r
    vO_syn_r = ROB * cons[96] * cons[21] * NOPE_r / cons[26] / den_r
    vP_syn_r = ROB * cons[96] * cons[22] * NPPE_r / cons[27] / den_r
    vL_syn_r = ROB * cons[96] * cons[23] * NLPE_r / cons[28] / den_r
    vS_syn_r = ROB * cons[96] * cons[24] * NSPE_r / cons[29] / den_r
    c_FAAH_ROB = cons[97] * cons[42] + cons[98] * cons[44] + cons[99] * cons[45] + cons[100] * cons[46] + cons[101] * cons[47] + cons[102] * cons[48] + cons[103] * cons[50]
    ...
    A_p = 0.8740574
    vA_m_p = MEC * cons[109] * (A_m - A_p * cons[110]) / (A_m + A_p + cons[111])
    O_p = 5.085073
    vO_m_p = MEC * cons[112] * (O_m - O_p * cons[113])
    P_p = 4.849307
    vP_m_p = MEC * cons[114] * (P_m - P_p * cons[115])
    L_p = 1.916254
    vL_m_p = MEC * cons[116] * (L_m - L_p * cons[117])
    S_p = 0.273772
    vS_m_p = MEC * cons[118] * (S_m - S_p * cons[119])
    vA_b_m = MEC * cons[109] * (A_b - A_m) / (A_m + A_b + cons[111])
    vO_b_m = MEC * cons[112] * (O_b - O_m)
...
nameless_model_ = Model(
  ...
  nameless_ode_,
  [
      TimeEvent(nameless_evt1_times_, nameless_evt1_assignment_),
  ],
...
nameless_default_ = SimpleSTask(
    nameless_model_,    # model
    NamedTuple(),       # constants
    SubTask(            # subtasks
        collect(range(0., step=5.0, stop=100.)), # 
        Symbol[:GUT,:PLASMA,:ROB,:PFM_gut,:PFM_p,:PFM_r,:F_PFM,:dose_amount,:PF_p,:PF_b,:PF_r,:PF_m,:absorp,:dist,:elim,:BRAIN,:A_b,:O_b,:P_b,:L_b,:S_b,:NAPE_b,:NOPE_b,:NPPE_b,:NLPE_b,:NSPE_b,:FAAH_b,:FAAHinh_b,:FAAH_D_b,:vA_degr_b,:vO_degr_b,:vP_degr_b,:vL_degr_b,:vS_degr_b,:vNAPE_syn_b,:vNOPE_syn_b,:vNPPE_syn_b,:vNLPE_syn_b,:vNSPE_syn_b,:slag1_b,:slag2_b,:den_b,:vA_syn_b,:vO_syn_b,:vP_syn_b,:vL_syn_b,:vS_syn_b,:vFAAH_syn_b,:vFAAH_degr_b,:vFAAH_inh_b,:vFAAH_inh_degr_b,:vA_UE_b,:vO_UE_b,:vP_UE_b,:vL_UE_b,:vS_UE_b,:A_r,:O_r,:P_r,:L_r,:S_r,:NAPE_r,:NOPE_r,:NPPE_r,:NLPE_r,:NSPE_r,:FAAH_r,:FAAHinh_r,:FAAH_D_r,:vA_degr_r,:vO_degr_r,:vP_degr_r,:vL_degr_r,:vS_degr_r,:c_NAT_ROB,:vNAPE_syn_r,:vNOPE_syn_r,:vNPPE_syn_r,:vNLPE_syn_r,:vNSPE_syn_r,:slag1_r,:slag2_r,:den_r,:vA_syn_r,:vO_syn_r,:vP_syn_r,:vL_syn_r,:vS_syn_r,:c_FAAH_ROB,:vFAAH_syn_r,:vFAAH_degr_r,:vFAAH_inh_r,:vFAAH_inh_degr_r,:c_NAAA_ROB,:vA_UE_r,:vO_UE_r,:vP_UE_r,:vL_UE_r,:vS_UE_r,:MEC,:A_m,:O_m,:P_m,:L_m,:S_m,:FAAH_m,:FAAHinh_m,:FAAH_D_m,:vA_degr_m,:vO_degr_m,:vP_degr_m,:vL_degr_m,:vS_degr_m,:vFAAH_syn_m,:vFAAH_degr_m,:vFAAH_inh_m,:vFAAH_inh_degr_m,:A_p,:O_p,:P_p,:L_p,:S_p,:vA_m_p,:vO_m_p,:vP_m_p,:vL_m_p,:vS_m_p,:vA_b_m,:vO_b_m,:vP_b_m,:vL_b_m,:vS_b_m,:vA_r_p,:vO_r_p,:vP_r_p,:vL_r_p,:vS_r_p,]                             # output ids
    ),
    (0.0, 100.0),       # tspan
    solver = Dict(               # solver
        :alg => :Tsit5,
...
tasks = (
    nameless_default = nameless_default_,
)
