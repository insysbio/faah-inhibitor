...
### TIME EVENTS ###
function nameless_evt1_tstops_func_(cons, times)
    return [0.0]
end
...
### event assignments
function nameless_evt1_affect_func_(integrator)
    cons = integrator.p.constants
    t = integrator.t
    (GUT,PLASMA,ROB,BRAIN,MEC,) = integrator.p.static
...
nameless_model_ = (
  ...
  NamedTuple{(
    ...
    (nameless_evt1_tstops_func_, nameless_evt1_affect_func_, :evt1, false),
  ]),
  NamedTuple{(
  )}([
  ]),
